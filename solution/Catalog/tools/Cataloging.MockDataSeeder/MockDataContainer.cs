...
public static class MockDataContainer
{
    ...
    public static IEnumerable<Book> GetBooks(IEnumerable<Author> authors)
    {
        ...
        var theShining = new Book("The Shining", new DateTime(1977, 1, 28), StephenKingId);
        theShining.SetId(Guid.Parse("A125C5BD-4F8E-4794-9C36-76E401FB4F24"));

        books.AddRange(new[] {
            theShining,
            new Book("The Green Mile", new DateTime(1996, 3, 28), StephenKingId),
            new Book("End of Watch", new DateTime(2016, 6, 7), StephenKingId),

            new Book("Angels and Demons", new DateTime(2000,5,15), DanBrownId),
            new Book("The Da Vinci Code", new DateTime(2003, 3, 18), DanBrownId),
            new Book("Inferno", new DateTime(2013, 5, 14), DanBrownId),

            new Book("Harry Potter and the Philosopher's Stone", new DateTime(1997, 6,26), JkRowlingId),
            new Book("Fantastic Beasts and Where to Find Them", new DateTime(2001, 3, 15), JkRowlingId),
            new Book("Harry Potter and the Deathly Hallows", new DateTime(2007, 7, 21), JkRowlingId),

            new Book("The Old Man and The Sea", new DateTime(1952, 1, 1), ErnestHemingwayId),
            new Book("For Whom the Bell Tolls", new DateTime(1940, 1, 1), ErnestHemingwayId),
            new Book("A Farewell to Arms", new DateTime(1929, 1, 1), ErnestHemingwayId),
        });
